        ...
        function caricaImmagini() {
            ...
            xhr.onreadystatechange = function () {
                if (xhr.readyState == 4 && xhr.status == 200) {
                    ...
                    var contenitoreImmagini = document.getElementById("contenitoreImmagini");
    ...
    profileImage.src = "https://mdbcdn.b-cdn.net/img/new/avatars/1.webp";
    ...
    mainImage.src = "data:image/jpeg;base64," + datiJSON[i].immagine_blob;
    mainImage.alt = datiJSON[i].nome;
    ...
    likedInfo.textContent = "Liked by ";
    var strongTag = document.createElement("strong");
    strongTag.textContent = "Edward Jones and 254 others";
