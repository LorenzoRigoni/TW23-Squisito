        ...
        function caricaPost() {
            ...
            const url = '/tw23-squisito/model/post_models/get_single_post.php?IDPost=' + IDPost;
...
// Creare la card di Bootstrap
	document.getElementById("nomeUtente").textContent = datiJSON[0]['UsernamePost'];
    document.getElementById("Paese").textContent = datiJSON[0]["Nazione"];
	document.getElementById("testoRicetta").textContent = datiJSON[0]["Ricetta"];
	var flagElement =document.getElementById("flag");
	flagElement.src = "/tw23-squisito/view/style/flags/" + datiJSON[0]["Shortname"] + ".png";
	var fotoProfiloPost =document.getElementById("fotoUtentePost");
	fotoProfiloPost.src = "data:image/jpeg;base64,"+ datiJSON[0]["FotoProfilo"];
